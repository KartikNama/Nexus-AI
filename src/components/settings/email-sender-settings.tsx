...
export function EmailSenderSettings({ compact = false }: EmailSenderSettingsProps) {
  ...
  const handleSelectMode = async (nextMode: EmailSenderMode) => {
    ...
    await patchSettings({ mode: "platform" }, { successMessage: "Using Nexus AI email", setBusy: setSavingMode });
  };
        ...
        [
          {
            ...
            title: "Nexus AI email",
            description: "Send from the platform address configured by Nexus AI. No setup required.",
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          {currentWorkspace?.name ?? "your group"}. Use Nexus AI email by default, or verify your
