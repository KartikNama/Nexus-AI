...
/** Plus Jakarta Sans / Inter for headings and body */
const FONT_DISPLAY = '"Plus Jakarta Sans", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif';
const FONT_SANS =
...
const MARKETING_TAGLINE = "Relationship intelligence and network graphs for teams";
const DEFAULT_BANNER = "Warm introductions. High-conviction relationships. Built for teams.";
...
export interface BrandedEmailContent {
  ...
  secondaryUrl?: string;
  footerNote?: string;
  /** Top banner. Defaults to product marketing line when omitted; pass null to hide. */
  banner?: string | null;
    ...
    <tr>
      <td align="center" style="padding:44px 20px 52px;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;">
            ...
            <td style="padding-bottom:28px;text-align:center;">
              <table role="presentation" cellspacing="0" cellpadding="0" align="center">
                <tr>
                  ...
                  <td style="padding-left:14px;font-family:${FONT_DISPLAY};font-size:24px;font-weight:700;color:${COLORS.text};line-height:1;vertical-align:middle;">
                    Nexus AI
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background-color:${COLORS.white};border:1px solid ${COLORS.border};border-radius:16px;padding:42px 36px;box-shadow:0 4px 24px rgba(15,23,42,0.06);">
              <h1 style="margin:0 0 10px;font-family:${FONT_DISPLAY};font-size:26px;font-weight:700;color:${COLORS.text};line-height:1.25;letter-spacing:-0.02em;">
                ${content.heading}
              </h1>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0">
                <tr>
                  <td style="border-radius:10px;background-color:${COLORS.forest};">
                    <a href="${content.ctaUrl}" target="_blank" style="display:inline-block;padding:14px 30px;font-family:${FONT_SANS};font-size:15px;font-weight:600;color:${COLORS.white};text-decoration:none;letter-spacing:0.01em;border-radius:10px;">
                      ${content.ctaLabel}
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:28px 12px 0;text-align:center;">
              ...
              <p style="margin:8px 0 0;font-family:${FONT_DISPLAY};font-size:14px;font-weight:600;color:${COLORS.forest};letter-spacing:-0.01em;">
                nexus.ai
              </p>
            </td>
          </tr>
...
export async function chatMessageEmail(input: {
  ...
  return renderPlatformEmail("chat_message", {
    ...
    footerNoteOverride: input.onPlatform
      ? "Reply in Nexus AI to keep the conversation in one place."
      : undefined,
  });
}
